                ...
                @if (isset($products) && $products->count() > 0)
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="search" class="form-control" id="search_product" placeholder="{{ __('user.search') }}" category_id="{{ $category_id }}">
                                {{-- <p style="display: none;" id="category_id">{{ $category_id }}</p> --}}
