$(document).ready(function () {
    ...
    $(document).on('click' , '.add-product-btn' , function(e){
        ...
        $("#products_select").text( $("#products_select").text() + ' ' + id) ;
    ...
    $('body').on('click', '.remove-product-btn', function(e) {
        ...
        products_select = products_select.split(" ") ;
        var search = products_select.indexOf(id.toString()) ;
        products_select.splice(search , 1) ;
        var products_select = products_select.toString() ;
        products_select = products_select.replace( /,/g , " ") ;
        console.log(products_select) ;
        $("#products_select").text(products_select) ;
